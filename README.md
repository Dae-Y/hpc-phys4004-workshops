...
- `week03/` - MPI non-blocking communication, and master/worker parallelism
- `week04/` - ...



## Requirements
- MPI compiler (`cc`, `ftn`, or `mpicc`)
- Access to a supercomputing environment (e.g., Pawsey Setonix)
